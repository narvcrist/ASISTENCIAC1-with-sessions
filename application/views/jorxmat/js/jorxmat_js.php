...
jQuery(document).ready(function(){
   ...
   var numero='<?php echo !empty($sol->JORXMAT_SECUENCIAL) ? prepCampoMostrar($sol->JORXMAT_SECUENCIAL) : null ; ?>';
...
$("#fjorxmat").validate({
       ...
       submitHandler: function(form){
           $.ajax({
               type: "POST",
               url:  "jorxmat/admJorxmat/"+accion,
               data: $("#fjorxmat").serialize(),
               dataType:"json",
               success: function(r){
                       if (r.cod>0) {
                           $("#fjorxmat").jConfirmacion({
                                        titulo:"Jorxmat: "+r.numero,
                                        mensaje: r.mensaje,
                           ...
                           if (accion=='n'){
                                $("#JORXMAT_SECUENCIAL").val(r.numero);
								}
                                $("#co_grabar").hide();
                       } else {
